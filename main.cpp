...
int main() {
	...
	PRINT_EXEC(auto [c_perspective, c_translation, c_scaling, c_shear, c_rotation] = decompose_mat4x4(transform));
	PRINT_EXEC(print(c_perspective));
	PRINT_EXEC(print(c_translation));
	PRINT_EXEC(print(c_scaling));
	PRINT_EXEC(print(c_shear));
	PRINT_EXEC(print(c_rotation));
	PRINT_EXEC(transform = m_rotation * scaling(vec(0, 2, 1, 1)));
	PRINT_EXEC(std::tie(c_perspective, c_translation, c_scaling, c_shear, c_rotation) = decompose_mat4x4(transform));
	PRINT_EXEC(print(c_perspective));
	PRINT_EXEC(print(c_translation));
	PRINT_EXEC(print(c_scaling));
	PRINT_EXEC(print(c_shear));
	...
	PRINT_EXEC(print(normalize(vec<float>(1,1,1))));
	PRINT_EXEC(print(normalize_max(vec<float>(1,5,10))));
	PRINT_EXEC(print(normalize_minmax(vec<float>(-10,5,10))));
	...
	PRINT_EXEC(print(reflect(vec<float>(-1,1,0), vec<float>(0,1,0))));
